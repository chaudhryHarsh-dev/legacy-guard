...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-16 md:py-28 lg:py-36 relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
          ...
          <p 
            className="text-muted-foreground text-base md:text-lg lg:text-xl leading-relaxed opacity-0 animate-fade-in"
